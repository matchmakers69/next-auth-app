...
import { runGeneralInfoValidation } from "@/app/(root)/(dashboard)/subscriptions/_actions/run-general-info-validation";
  ...
  return (
    <>
      ...
      >
        ...
        <SubscriptionStepperFooter isPending={isPending} />
      </form>
    </>
  );
};
